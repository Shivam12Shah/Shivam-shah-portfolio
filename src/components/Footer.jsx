...
const Footer = () => {
  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
      ...
      <div>
        ...
        <div className="flex gap-4">
          <Link to="https://github.com/Shivam12Shah" target='_blank' className="p-3 border border-[#f5f5f5]/20 rounded-full hover:bg-[#f5f5f5] hover:text-[#121212] transition-colors">
            <FaGithub />
          </Link>
          <Link to="https://www.linkedin.com/in/shivam-kumar-shah-19b347209/" target='_blank' className="p-3 border border-[#f5f5f5]/20 rounded-full hover:bg-[#f5f5f5] hover:text-[#121212] transition-colors">
            <FaLinkedinIn />
          </Link>
          <Link to="https://github.com/Shivam12Shah" className="p-3 border border-[#f5f5f5]/20 rounded-full hover:bg-[#f5f5f5] hover:text-[#121212] transition-colors">
            <FaInstagram />
          </Link>
          <Link to="https://github.com/Shivam12Shah" className="p-3 border border-[#f5f5f5]/20 rounded-full hover:bg-[#f5f5f5] hover:text-[#121212] transition-colors">
            <FaTelegramPlane />
    ...
    <div className="mt-16 pt-8 border-t border-[#f5f5f5]/10 text-center opacity-60">
      <p>© 2025 Shivam Kumar Shah. All rights reserved.</p>
    </div>
  </footer>
  )
}
