...
const About = () => {
  ...
  return (
    <div className="about mt-12 md:py-5">
      <div className="max-w-4xl">
        <div className="flex flex-col md:flex-row gap-8">
          <div className="md:w-2/3">
            <h1 className="font-semibold text-2xl md:text-3xl">.../About me</h1>
            <p className="mt-6 text-lg leading-relaxed opacity-90">
              Full Stack Software Engineer with 3+ years of experience building scalable web applications and microservices using TypeScript, Node.js, React.js, Java, and Python. Experienced in CI/CD pipelines, Agile methodologies, test-driven development, and performance monitoring across cloud-native AWS infrastructure.
            </p>

            <div className="mt-8">
              <div className="p-4 rounded-lg bg-[#1a1a1a] border border-[#f5f5f5]/10">
                <h4 className="font-medium">Sagar Institute of Research and Technology</h4>
                <p className="text-gray-400 mt-2">B.Tech – Computer Science Engineering</p>
                <p className="text-gray-400 mt-1 text-sm">Aug 2020 – Jun 2024 | CGPA: 8.31 / 10.0</p>
              </div>
            </div>

            <div className="mt-8 flex gap-4">
              <button className="px-6 py-2 bg-[#f5f5f5] text-[#121212] rounded-lg hover:opacity-90 transition-opacity">
                <a href="/Shivam_shah_resume.pdf" download > Resume </a>
